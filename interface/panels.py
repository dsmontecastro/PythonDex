...
class InformationPanel:
    ...
    def initialize_components(self):
        ...
        try:
            self.pokemon_image = p.image.load(
                "resources/pokemon/{}.jpg".format(self.name.lower())
            )
        except FileNotFoundError:
            pass
        try:
            self.pokemon_image = p.image.load(
                "resources/pokemon/{}.png".format(self.name.lower())
            )
        except FileNotFoundError:
    ...
    def update_pokemon_sprite(self):
        try:
            self.pokemon_image = p.image.load(
                "resources/pokemon/{}.jpg".format(self.data.name.lower())
            )
        except FileNotFoundError:
            pass
        try:
            self.pokemon_image = p.image.load(
                "resources/pokemon/{}.png".format(self.data.name.lower())
            )
        except FileNotFoundError:
            pass
        self.pokemon_image.anchor_x = self.pokemon_image.width
...
class SearchPanel:
    def __init__(self, database, x, y):
        ...
        self.field_image = p.image.load("resources/tiles/select_inactive.png")
